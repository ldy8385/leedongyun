...
function showStartMenu() {
    ...
    setBitmapText("font1", I18.f("play"), i, 0, -5, 0, 1);
    var a = e.addChild(library.getSprite("button/menu/clear_data", {
        ...
        onclick: function(t) {
            ...
            setBitmapText("font2", I18.f("sure1"), s, 0, -25, 0, .9), setBitmapText("font3", I18.f("sure2"), s, 0, 5, 0, .9);
            ...
            setBitmapText("font3", I18.f("yes").toUpperCase(), o, -1, -1, 0, .4);
            var h = g.addChild(library.getSprite("button/no", {
                x: 30,
                y: s.y + s.height / 2
            }));
            setBitmapText("font3", I18.f("no").toUpperCase(), h, -1, -1, 0, .4), g.onclick = function() {
                return g.destroy = !0, !1
            }
        }
    }));
    setBitmapText("font1", I18.f("clear"), a, 0, -3, 0, .9), clearedGameData() ? a.visible = !1 : i.y -= 46;
...
function fxPreBattle(e, t) {
    ...
    s.bitmap = null, setBitmapText("font_red", I18.f("ready"), s, 0, 0, 0, .4), e.addChild(g).fadeTo(0, a, i, function(g) {
        e.removeChild(g.target.obj), e.setTimeout(function() {
            ...
            }), setBitmapText("font_red", I18.f("go"), g, 0, 0, 0, .4), t()
        }, a / 2)
    })
}
...
function showUpgrades() {
    ...
    }, e.start(), e.refreshBackground(), Tutorial.show("money", e, g), setBitmapText("font1", I18.f("upgrades").toUpperCase(), e, 240, 20, 0, 1), setBitmapText("font5", I18.f("choose"), e, 190, 300, 0, 1), ExternalAPI.exec("addY8Logos", 30, 301, 450, 301, e)
}
...
function addBtnWT(e, t, i, a, g) {
    function s() {
        // var e = "http://kizi.com/videos/click-battle-madness",
    ...
    setBitmapText(a, I18.f("walkthrough"), o, 10, -2, null, .9 * g);
...
GAME_CONFIG.enemy.types = [], GAME_CONFIG.enemy.types.push({
    ...
    types: [{
        ...
        gold: 300,
        timeout: 16,
        units: [4, 5, 4, 5, 4, 5, 9, 9, 10, 10, 11]
    }, {
        type: 6,
        hp: 500,
        gold: 300,
        ...
        gold: 300,
        timeout: 16,
        units: [5, 9, 10, 10, 11, 11, 12, 10, 11, 12]
    }, {
        type: 8,
        hp: 500,
        gold: 300,
        timeout: 16,
        units: [9, 10, 10, 11, 11, 12, 10, 11, 12, 12, 13, 12, 11]
    }, {
        type: 9,
        hp: 500,
        gold: 300,
        ...
        gold: 300,
        timeout: 16,
        units: [10, 11, 11, 12, 12, 12, 13, 13, 13, 14, 14, 14]
    }, {
        type: 11,
        hp: 500,
        gold: 300,
        ...
        gold: 300,
        timeout: 16,
        units: [10, 11, 12, 13, 13, 13, 14, 14, 14, 15]
    }, {
        type: 13,
        hp: 500,
        gold: 300,
        ...
        gold: 300,
        timeout: 16,
        units: [12, 13, 13, 13, 14, 14, 14, 15, 15, 17, 17]
    }, {
        type: 15,
        hp: 500,
        gold: 300,
...
Castle.prototype.init = function() {
    ...
    for (var n = [], f = Upgrade("towersCount").level, h = 0; f > h; h++) {
        ...
        d.gotoAndStop(Math.round(Upgrade("towersLevel").progress * d.totalFrames)), this.stage.addChild(d), d.onDie = Utils.proxy(function(e) {
...
Utils.extend(EnemyUnit, Sprite), EnemyUnit.STATE_ONBOARD = 0, EnemyUnit.STATE_INCOMING = 1, EnemyUnit.STATE_MOVE = 2, EnemyUnit.STATE_ATTACK = 3, EnemyUnit.STATE_FROZEN = 4, EnemyUnit.STATE_DEAD = 255, EnemyUnit.createInstance = function(e, t) {
    ...
    var t = "enemy/unit/bones" + random(1, 7);
...
Battle.timeToTicks = function(e) {
    ...
    s.fillColor = "rgba(64,0,0,0.5)", s.opacity = 0, s.onclick = function() {
        ...
        i.addChild(g), setBitmapText("font4", I18.f("complete"), g, -10, -58, 0, .6, null, null, -6), g.moveTo(i.screenWidth / 2, i.screenHeight / 2, 500, Easing.bounce.easeOut, function() {
            var t = "font/black",
    ...
    t.fillColor = "rgba(0,64,0,0.5)", t.opacity = 0, t.onclick = function() {
        ...
        t.addChild(i), setBitmapText("font1", I18.f("win").toUpperCase(), i, 0, -65, 0, 1)
